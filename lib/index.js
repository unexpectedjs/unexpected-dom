    ...
    expect.addAssertion('HTMLElement', 'to [only] have (attribute|attributes)', function (expect, subject, cmp) {
      ...
      if (Array.isArray(cmp)) {
        ...
        if (this.flags.exhaustively) {
          if (cmp['class']) {
            comparator['class'] = function (classes) {
              expect(classes.slice().sort(), 'to satisfy', cmpClasses.slice().sort());
            };
          }
          ...
          if (cmp['class']) {
            ...
            comparator['class'] = function (classes) {
              cmpClasses.forEach(function (expectedClass) {
                expect(classes, 'to contain', expectedClass);
              });
            };
          }
